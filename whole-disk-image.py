...
g.selinux_relabel('/etc/selinux/targeted/contexts/files/file_contexts', '/home', force=True)
...
g.selinux_relabel('/etc/selinux/targeted/contexts/files/file_contexts', '/var/log/audit', force=True)
